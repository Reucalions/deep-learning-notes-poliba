...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{l X l c X}
    \toprule
    \textbf{Modello} & \textbf{Vincolo} & \textbf{Sp.\ latente}
      & \textbf{Gen.} & \textbf{Applicazione tipica} \\
    \midrule
    AE classico & $k < d$                                             & Punto          & No & Compressione, pre-training \\
    Sparse AE   & $\ell_1$ su $\mathbf{a}$                            & Punto sparso   & No & Feature learning \\
    Deep AE     & Più livelli                                         & Punto profondo & No & Compressione non lineare \\
    U-Net       & Skip connections                                    & ---            & No & Segmentazione semantica \\
    VAE         & $\mathrm{KL}(\cdot\|\mathcal{N}(\mathbf{0},\mathbf{I}))$ & Distribuzione  & Sì & Generazione, interpolazione \\
    \bottomrule
  \end{tabularx}
\end{table}
