...
\begin{table}[H]
  ...
  \begin{tabular}{llll}
    ...
    \midrule
    VAE
      & Distribuzione $\mathcal{N}(\boldsymbol{\mu}, \boldsymbol{\sigma}^2)$
      & Media (campioni sfocati)
      & Ottimizzazione ELBO \\
    GAN
      & Vettore latente $\mathbf{z} \sim p_z$
      & Alta (campioni nitidi)
      & Mode collapse, instabilità \\
    Normalizing Flow
      & Biiezione esatta
      & Alta (log-likelihood esatta)
