...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{l l l l X}
    \toprule
    \textbf{Modello} & \textbf{Spazio}
      & \textbf{Qualità} & \textbf{Diversità} & \textbf{Criticità} \\
    \midrule
    GAN              & Pixel/latente & Alta           & Bassa         & Instabilità, mode collapse \\
    VAE              & Latente       & Media          & Alta          & Campioni sfocati \\
    Normalizing Flow & Biiezione     & Alta           & Alta          & Architettura vincolata \\
    Diffusion pixel  & Pixel         & Molto alta     & Alta          & Inferenza molto lenta \\
    Latent Diffusion & Latente       & Molto alta     & Alta          & Inferenza lenta \\
    \bottomrule
  \end{tabularx}
\end{table}
